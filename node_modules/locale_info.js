...
exports = module.exports =
{
     ...
     */
    connect: function(defaultLocale)
    {
        var locales,
            callbacks = [],
        ...
        exports.getAllLocaleInfo(function (err, data)
        {
            locales = data || {};
     ...
     * system.
     */
    getAllLocaleInfo: function (done)
    {
        var result = {},
            count = 0,
            ...
            parse = function (error, stdout, stderr)
            {
                ...
                {
                    exports.getLocaleInfoUtf8(lines[i], group(lines[i]));
                }
            };
     ...
     */
    getLocaleInfo: function(locale, done)
    {
        var categories =
            [
                'LC_ADDRESS',
     ...
     */
    getLocaleInfoUtf8: function(locale, done)
    {
        var parse = function (error, stdout, stderr)
            {
                ...
                {
                    exports.getLocaleInfo(locale, function (err, data)
                    {
                        done(err, data);
                    });
                }
